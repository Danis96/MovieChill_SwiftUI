...
class DeveloperPreview {
    ...
    let castList = [
        Cast(adult: false, gender: 2, id: 1748, knownForDepartment: "Acting", name: "William Shatner", originalName: "William Shatner", popularity: 18.463, profilePath: "/7lsjbNFMGj3kYYWoMk1LNnl4p5P.jpg", castID: 5, character: "Admiral James T. Kirk", creditID: "52fe421fc3a36847f8005c03", order: 0, department: nil, job: nil, profileFullPath: nil, imageData: Image("testPoster")),
